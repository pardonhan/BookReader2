...
public class PageModeDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.book.book.R.layout.dialog_pagemode);

        tv_simulation = (TextView) findViewById(com.book.book.R.id.tv_simulation);
        tv_cover = (TextView) findViewById(com.book.book.R.id.tv_cover);
        tv_slide = (TextView) findViewById(com.book.book.R.id.tv_slide);
        tv_none = (TextView) findViewById(com.book.book.R.id.tv_none);


        findViewById(com.book.book.R.id.tv_simulation).setOnClickListener(this);
        findViewById(com.book.book.R.id.tv_cover).setOnClickListener(this);
        findViewById(com.book.book.R.id.tv_slide).setOnClickListener(this);
        findViewById(com.book.book.R.id.tv_none).setOnClickListener(this);
