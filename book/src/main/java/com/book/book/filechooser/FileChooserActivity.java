...
public class FileChooserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.book.book.R.layout.activity_filechooser);
        toolbar = (Toolbar) findViewById(com.book.book.R.id.tool_bar);
        toolbar.setTitle("请选择图书");
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbar.setNavigationIcon(com.book.book.R.drawable.bt_nav_back);
        ...
        fragmentTransaction.add(com.book.book.R.id.fragment_container, mDirectoryFragment, "" + mDirectoryFragment.toString());
