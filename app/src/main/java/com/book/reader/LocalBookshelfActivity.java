...
import com.book.reader.base.SingleAdapter;
import com.book.reader.base.SuperViewHolder;
import com.book.book.ReadActivity;
import com.book.book.db.BookList;
import com.book.book.filechooser.FileChooserActivity;
...
public class LocalBookshelfActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        adapter = new SingleAdapter<BookList>(LocalBookshelfActivity.this, R.layout.item_book) {
            @Override
            protected void bindData(SuperViewHolder holder,final BookList book) {
